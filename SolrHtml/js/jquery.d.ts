...
interface JQueryStatic {
    ...
    **********/
    ...
    /*********
     Plugin PubSub
    **********/
    subscribe(eventType:string, arguments:any): JQuery;
    unsubscribe(eventType:string, arguments:any): JQuery;
    publish(eventType:string, arguments:any): JQuery;

    /***********
     Plugin JSRender
    **********/
    templates(templates: any): JQuery;
    render(): JQuery;
    views(): JQuery;
    helpers(): JQuery;
...
interface JQuery {
    ...
    ***********/
    ...
    helpers(option: any): JQuery;

    standardAutocomplete(solrUrl: string, fieldName:string): JQuery;
}
